...
\vspace{-0.3em}
La collaboration est permise en formant une équipe de 3 personnes au maximum. Sur \href{https://www.gradescope.com/}{Gradescope}, ajoutez vos coéquipiers.ières après avoir sélectionné les pages correspondant à chaque numéro en soumettant le devoir une première fois.\par
\vspace{1em}
\hrule
\end{document}
%------- END HOMEMADE FOOTER -------%