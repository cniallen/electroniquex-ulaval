...
\end{center}
%\vspace{-1em}
\noindent Automne 2025 \hfill Responsables: X. Roy-Pommerleau, C. Allen
...
\begin{enumerate}[label=\Roman*., itemsep=3ex, wide, labelwidth=!, labelindent=0pt]
    \setcounter{enumi}{0}
    \vspace{3ex}
    \item \subfile{DevoirExa/DC stationnaire/DC_006}
    \vspace{2ex}
    \item \subfile{DevoirExa/DC stationnaire/DC_001}
    \newpage
    \item \subfile{DevoirExa/DC stationnaire/DC_010}
    %\vspace{5ex}
    \item \subfile{DevoirExa/DC stationnaire/DC_011}
\end{enumerate}
