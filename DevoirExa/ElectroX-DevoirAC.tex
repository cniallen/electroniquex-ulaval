...
\end{center}
%\vspace{-1em}
\noindent Automne 2023 \hfill Responsable: C. Allen
\vspace{0.2em}
\hrule
\vspace{-1.5ex}
%\centering 
...
\end{center}
\vspace{-4ex}
Début: 17 novembre 2023 \hfill Fin: 28 novembre 2023\par
\vspace{0.4em}
\hrule
\justify
%------ END HOMEMADE TITLE ------%
...
\begin{enumerate}[label=\Roman*., wide, labelwidth=!, labelindent=0pt]
    \setcounter{enumi}{0}
%    \vspace{2ex}
    \item \subfile{DevoirExa/AC transitoire ou permanent/AC_002}
    \vspace{6ex}
    \item \subfile{DevoirExa/AC transitoire ou permanent/AC_001}
\end{enumerate}
