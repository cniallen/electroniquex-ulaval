...
%---------------------------------------------------
%
\title{\textbf{Laboratoire II}\\Métrologie quantitative et méthodes de mesure en courant continu\thanks{Auteurs: Claudine Allen, Jean-Raphaël Carrier \& Vincent Méthot}}
...
\item \texttt{[observation]} Les mesures en circuit fermé avec la pomme de terre au premier laboratoire étaient-elles biaisées\dots~a) en tension ou b) en courant?
