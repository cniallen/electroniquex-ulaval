...
%Élimination du labo de résistivité des matériaux à la fin de l'ère JRC => renumérotation V -> IV maintenant
...
Les travaux effectués aborderont les objectifs d’ensemble 2, 3, 4, 5, 7, 9, 10, 11 et 12 du plan de cours et couvriront la qualité 5~--~utilisation d’outils d’ingénierie, prescrite dans les normes du Bureau d’agrément d’Ingénieurs Canada (BAIC).
\newpage
...
Écrivez en moins de 150 mots l'abrégé \textit{(abstract)} d'un rapport qui porterait sur cette séance de laboratoire.
