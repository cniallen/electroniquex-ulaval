...
\vspace{1ex}
Dépôt des livrables sur Gradescope: 6 décembre à 8h30 \hfill Présentations: 7 décembre (voir horaire)\par %mettre le dépôt des livrables sur Gradescope un solide 2 jours avant la présentation.
%\vspace{0.4em}
\hrule
\justify
%------ END HOMEMADE TITLE ------%
...
\begin{itemize}
    ...
    \begin{itemize}[label=$\bullet$]
        ...
        %Les liens Tinkercad expirent, risquant de d'empêcher de la correction si trop de temps s'écoule après le partage!!! Demander des photos IRL avec une équivalence explicite avec le plan EDA...
