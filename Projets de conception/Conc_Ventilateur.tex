...
%Dernière modification CA : 23 décembre 2022
%
%%%ToDo
...
\begin{itemize}
    ...
    \item Enregistrement vidéo d'environ \SI{15}{\min} avec diapositives pour présenter les éléments indiqués dans la Table~\ref{tab:1} qui liste les critères d'évaluation.
