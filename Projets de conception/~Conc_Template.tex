%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%~Conc_Template.tex : Modèle de document pour le projet de conception, Électronique et mesures expérimentales GPH-2006 | Physique électronique PHY-2002, Département de physique, de génie physique et d'optique - FSG - Université Laval
%------------------------------------------------------------------
...
\vspace{-1em}
\noindent Session année \hfill Responsable: C. Allen\par
\vspace{0.2em}
\hrule
\vspace{0.5em}
\centering 
...
\vspace{-0.3em}
La collaboration dans le respect des règles de la santé publique est demandée pour ce projet en équipe de \textcolor{red}{XXXX}~personnes, veuillez évaluer la contribution de vos coéquipiers.ères dans l'onglet \texttt{Évaluation des pairs} de l'évaluation \texttt{Projet de conception} sur le site Internet du cours.\par
\vspace{1em}
\hrule
%\thispagestyle{empty}
\end{document}
