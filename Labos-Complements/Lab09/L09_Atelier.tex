...
;\end{circuitikz}
\caption{\textbf{4\textsuperscript{e} sous-objectif} : Déterminer comment ce circuit bistable agit comme une bascule asynchrone sur les entrées S et R en tension.}%% modifier pour faire ressortir le comportement de mémoire vive et ajuster le critère correspondant dans ~Trucs pour dépanner.
\label{sch-RS}
\end{figure}
