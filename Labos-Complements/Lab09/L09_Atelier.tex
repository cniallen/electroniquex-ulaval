...
\setlength{\parskip}{1ex plus 0.5ex minus 0.2ex}
Les ateliers se rapprochent d'un mode de travail expérimental plus professionnel et d'un à l'autre, ils vous mèneront vers une conception de plus en plus libre de vos propres designs de circuits. Pour vous y préparer, lisez le complément en lecture préparatoire et, dans votre cahier de recherche, écrivez les manipulations et les analyses à faire pour atteindre chaque sous-objectif. N'oubliez pas de considérer des étapes de modélisation, conception et simulation s'il y a lieu, sans oublier de calculer à l'avance toute valeur qui pourra se comparer aux expériences.
