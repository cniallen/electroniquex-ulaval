...
\item \textsc{Section de rapport - Méthodes expérimentales:} Écrivez en moins de 200 mots les méthodes expérimentales d'un rapport de recherche portant sur la première partie de ce laboratoire. C'est en effet sur la \nameref{sec:part1} seulement.
\end{enumerate}
