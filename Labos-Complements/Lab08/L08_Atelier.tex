...
\subsection{Optionnel - Oscillations avec la puce 555}
...
;\end{circuitikz}
\caption{\label{sch-alarme-1}\textbf{Sous-objectif:} Sur Tinkercad, connecter un haut-parleur à la sortie $v_\mathrm{out}$ de la puce 555. Déterminer un ensemble de valeurs de $R_A$, $R_B$ et $C$ qui permettent de générer un signal de sortie pouvant générer un son à une fréquence audible.}
\end{figure}
