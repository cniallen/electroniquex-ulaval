...
;\end{circuitikz}
\caption{\label{sch-osc-Wien}\textbf{Sous-objectif:} Démontrer que ce circuit agit comme un filtre en prenant les mesures appropriées pour identifier sa bande passante. Également, étudier l'effet de l'ajout d'une charge (résistance??) entre la sortie $v_{\mathrm{out}}$ et la mise à la terre.}
\end{figure}
...
\subsection{Conception - Oscillateur harmonique à rétroaction (LC)}
