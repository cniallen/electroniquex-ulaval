...
%---------------------------------------------------
%
\title{\textbf{Laboratoire VIII}\\Oscillateurs électroniques\thanks{Auteurs: Claudine Allen, Jérémie Guilbert \& Jean-Raphaël Carrier}}
...
\subsection{Partie 4 --- Oscillateur harmonique à rétroaction (LC)}
...
\subsection{Partie 5 --- Oscillations avec la puce 555}
