...
%Élimination du labo de résistivité des matériaux à la fin de l'ère JRC => renumérotation IX -> VIII maintenant
...
%---------------------------------------------------
%
\title{\textbf{Laboratoire VIII}\\Filtres passifs, actifs et numériques\thanks{Auteurs: Claudine Allen \& Jean-Raphaël Carrier}}
...
\begin{itemize}
\item lire le complément \textit{Analyse temporelle};
\item lire le complément \textit{Analyse fréquentielle};
...
\subsection{Partie 4 optionnelle --- Résolution expérimentale du devoir 2}

Montez les deux circuits du \textit{Devoir~2} pour obtenir leurs diagrammes de Bode à l'aide de \textit{LabVIEW}. Vous serez alors en mesure de vérifier vos calculs!
