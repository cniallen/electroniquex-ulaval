...
%Élimination du labo de résistivité des matériaux à la fin de l'ère JRC + regroupement des labos VI & VII en début de pandémie COVID-19 => renumérotation IX -> VII maintenant
%Dernière modification CA: 31 octobre 2020
...
%---------------------------------------------------
%
\title{\textbf{Laboratoire VII}\\Filtres passifs, actifs et numériques\thanks{Auteurs: Claudine Allen \& Jean-Raphaël Carrier}}
...
%Développer progressivement une méthodologie de travail en transition vers... l'ingénieur.e ou le.la scientifique professionnelle n'a pas de protocole pour ...
...
\item protocole de ce laboratoire.
\end{itemize}
...
%Équipe, I'd like I think, surtout si on peut merger des cahiers pour 2 utilisateurs (attention de ne pas perdre ceux déjà faits par contre!? individuel? check vs site de cours (ainsi que check titre du document ici en même temps)
Pour chacun des circuits ci-dessous, vous devez préparer le protocole qui permettra d'atteindre le sous-objectif indiqué en légende de la figure. Écrivez les manipulations à faire dans votre cahier de recherche afin de les présenter en partage d'écran Zoom pour évaluation pendant la première partie de la séance de cours virtuel.
...
;\end{circuitikz}
\caption{\label{sch-RC}Sous-objectif: Circuit RC série.}
\end{figure}
...
\subsection{Partie 3 --- Comparaison des coupures de différents filtres}
