...
\vspace{-1em}
\noindent Automne 2025 \hfill Responsable: C. Allen\par
\vspace{0.2ex}
\hrule
\vspace{0.5ex}
\centering
...
\subsection*{Matériel électronique permis}
\begin{itemize}
    ...
    \item Photorésistances
\end{itemize}
Le matériel qui n'est pas dans votre coffre se retrouvera sur une tablette de l'armoire contenant ces coffres. Si du matériel brise ou manque à l'appel en l'absence de l'équipe d'enseignement, n'hésitez pas à contacter notre précieuse équipe de support de laboratoire au VCH-0646 ou au téléphone (418) 656-2131 p.413146 pendant les heures de bureau. 
%\vspace{-1ex}
...
\vspace{-2ex}
\begin{itemize}
    \item Équipe de travail de 4 personnes sur \href{https://www.gradescope.com/}{Gradescope} correspondant à celle du site de cours. Si le nombre d'inscriptions au cours ne se factorise pas par 4, une ou deux équipes de moins de 4 membres seront permises avec l'autorisation d'une responsable.
